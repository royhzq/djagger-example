"""
Django settings for djagger_example project.
...
SECRET_KEY = "django-insecure-uk_+$2%u9f#k41^$+8+t_$u728n3ta#5qh_m9$(n@1h6vr@#^u"
...
ROOT_URLCONF = "djagger_example.urls"
...
WSGI_APPLICATION = "djagger_example.wsgi.application"
...
View the Django project that generated this document on Github: https://github.com/royhzq/djagger-example.
    ...
    "servers": [
        {"url": "https://example.org", "description": "Production API server"},
        {"url": "https://staging.example.org", "description": "Staging API server"},
    ],
}
